					...
					<tbody>
							...
							<td>
								<Dropdown drop="left">
									...
									<Dropdown.Menu>
										...
										<Dropdown.Item href="/recordpayment">Record Payment</Dropdown.Item>
									</Dropdown.Menu>
								</Dropdown>
							</td>
						</tr>
						...
						<tr id="border-b-0">
							...
							<td id="text-center">
								...
								<Button variant="secondary" size="sm" disabled>Finalise</Button>
							</td>
							<td></td>
						</tr>
					</tbody>
							...
							<tr>
								...
								<td className="pt-0" id="text-right">
									<Form inline className="d-block">
										<Form.Control type="text" className="mr-sm-2 text-right" value="48,72,12,500 INR" />
									</Form>
								</td>
							</tr>
							<tr>
